...
class model(torch.nn.Module):
    def __init__(self, hidden_channels):
        ...
        #GMMConv layers
        self.gmmconv1 = GMMConv(num_node_features, hidden_channels, dim=4, kernel_size=3)
        self.gmmconv2 = GMMConv(hidden_channels, hidden_channels, dim=4, kernel_size=3)
        self.gmmconv3 = GMMConv(hidden_channels, hidden_channels, dim=4, kernel_size=3)

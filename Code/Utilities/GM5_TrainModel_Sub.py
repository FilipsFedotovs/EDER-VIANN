...
parser.add_argument('--EOS',help="Please enter the user eos directory", default='$EOS')
...
with open('$EOS/EDER-VIANN/Models/GCN'+ args.ModelNewName + '.csv', 'w', newline='') as file:

...
input_track_file_location=EOS_DIR+'/EDER-VIANN/Data/TRAIN_SET/GM1_TRACKS.csv'
input_seed_file_location=EOS_DIR+'/EDER-VIANN/Data/TRAIN_SET/GM2_GM3_RawSeeds_'+Set+'_'+SubSet+'_'+fraction+'.csv'
output_seed_file_location=EOS_DIR+'/EDER-VIANN/Data/TRAIN_SET/GM3_GM3_RawImages_'+Set+'_'+SubSet+'_'+fraction+'.pkl'

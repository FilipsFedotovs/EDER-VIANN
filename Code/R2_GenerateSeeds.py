     ...
     if UserAnswer=='R':
       ...
       if args.Log=='Y':
         try:
             ...
             UF.LogOperations(EOS_DIR+'/EDER-VIANN/Data/REC_SET/R_LOG.csv', 'UpdateLog', [[2,'Crude distance cuts',rec_no,eval_no,eval_no/(rec_no+eval_no),eval_no/len(eval_data)]])
